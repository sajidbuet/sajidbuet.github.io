...
%        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://www.sajid.bd}{{\footnotesize\faLink}\hspace*{0.13cm}www.sajid.bd}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
    ...
    \vspace{0.1 cm - 0.2 cm}


    \section{Brief Biography}
        \begin{onecolentry}
            Dr. Sajid Muhaimin Choudhury is a Professor in the Department of Electrical and Electronic Engineering at BUET. He received his Ph.D. from Purdue University, USA. His research spans  quantum computing, photonics, antenna, computing, embedded systems, and renewables. He is a Senior Member of IEEE, Founding President of The Optica Bangladesh Section, and Founding Chair of the IEEE Photonics Society Bangladesh Chapter.
        \end{onecolentry}
...
\begin{twocolentry}{
    ...
    Professor, Department of Electrical and Electronic Engineering (EEE) \\ \textbf{Bangladesh University of Engineering and Technology (BUET)} \\
        %\begin{highlights}
